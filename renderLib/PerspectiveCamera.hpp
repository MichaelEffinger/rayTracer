...
public:
    ...
    constexpr RayCamera() : pos{0.f, 0.f, 0.f}, U{1.f, 0.f, 0.f}, V{0.f, 1.f, 0.f}, W{0.f, 0.f, -1.f}, l(0.f), r(0.f), b(0.f), t(0.f), nx(0), ny(0), focal_length(0.f){}

    RayCamera(PointN<float,3> origin, VectorN<float,3> viewdir,float focalLength, float imagePlaneWidth, std::size_t width, std::size_t height) : pos(origin), nx(width), ny(height), focal_length(focalLength){
        W = (-viewdir).normalize(); 
